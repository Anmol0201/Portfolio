  ...
  return (
    <div className="min-h-screen bg-background font-mono">
      ...
      <motion.div
        className={`${
          isMobile
            ? "fixed top-4 left-3 right-3 max-h-[calc(100vh-7rem)] overflow-y-auto"
            : "fixed top-32 left-6 w-80"
        } z-40 bg-card/95 backdrop-blur-sm border border-border rounded-xl p-6 shadow-2xl`}
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <FloatingElement duration={4} delay={0.5}>
            <motion.div
              ...
              } rounded-lg overflow-hidden mb-6 border border-border glyph-border`}
          ...
          <motion.div
            className={`bg-accent text-accent-foreground ${
              isMobile ? "px-2 py-1 text-[10px]" : "px-3 py-1 text-xs"
            } rounded font-medium mb-6 tracking-wider pulse-glow`}
            initial={{ opacity: 0, scale: 0.8 }}
            animate={{ opacity: 1, scale: 1 }}
          ...
          >
            ...
            >
              <div
                ...
                } bg-secondary rounded border border-border flex items-center justify-center`}
              >
      ...
      <div
        className={`min-h-screen ${
          isMobile ? "p-3 pt-[85vh] pb-24" : "p-8 pl-96"
        }`}
      >
